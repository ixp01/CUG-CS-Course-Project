...
class TicTacToeGUI:
    def __init__(self):
        ...
        self.current_turn = 'X' if self.human_player == 'X' else 'O'
        
        # 创建状态标签
        self.status_label = tk.Label(
            self.window,
            text=f"你是 {self.human_player}，AI 是 {self.ai_player}",
            font=('Arial', 12),
            bg='#f0f0f0'
        )
    ...
    def restart_game(self):
        ...
        # 更新状态标签
        self.status_label.config(text=f"你是 {self.human_player}，AI 是 {self.ai_player}")
