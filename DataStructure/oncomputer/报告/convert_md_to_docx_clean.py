...
# -*- coding: utf-8 -*-
"""
清理版 Markdown to DOCX Converter
将Markdown文件转换为Word文档，去除粗体标记，生成干净的文本格式
"""
...
class CleanMarkdownToDocxConverter:
...
def main():
    """主函数"""
    print("=" * 60)
    print("📄 清理版 Markdown转Word文档工具")
    print("自动去除粗体标记，生成干净的文档格式")
    print("=" * 60)
    
    input_file = "数据结构实习报告_完整版.md"
    output_file = "数据结构实习报告_详细版.docx"  # 新文件名
    ...
    # 执行转换
    converter = CleanMarkdownToDocxConverter(input_file, output_file)
