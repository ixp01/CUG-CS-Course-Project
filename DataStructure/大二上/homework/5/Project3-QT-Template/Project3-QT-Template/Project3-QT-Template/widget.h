...
public:
    ...
    std::vector<std::string> vectorForEnglish;//存储英文字符
    std::vector<std::string> vectorForChinese;//存储符合条件的中文字符
    std::vector<std::string> *v1=new std::vector<std::string>(),*v2=new std::vector<std::string>();//存储从excel中获取的字符
